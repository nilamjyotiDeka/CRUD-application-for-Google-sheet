        ...
        val jsonObjectRequest = JsonObjectRequest(
            ...
            Response.Listener<JSONObject> { response ->
                ...
                if (response.has("bookList")) {
                    ...
                    Toast.makeText(this@Sheet2Activity, "No book list found in response", Toast.LENGTH_SHORT).show()
                }
            },
            Response.ErrorListener { error ->
                readProgressLayout.visibility = View.GONE
                ReadProgressBar.visibility = View.GONE
                Toast.makeText(this@Sheet2Activity, error.toString(), Toast.LENGTH_SHORT).show()
            }
        )
